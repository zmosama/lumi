...
const statusConfig: Record<AttendanceStatus, { label: string; icon: React.ElementType; class: string }> = {
  present: { label: 'حاضر', icon: CheckCircle, class: 'text-success' },
  absent: { label: 'غائب', icon: XCircle, class: 'text-danger' },
  late: { label: 'متأخر', icon: Clock, class: 'text-accent' },
};
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 font-ibm">الحضور والغياب</h1>
      ...
      <div className="card p-0 overflow-hidden">
        {isLoading ? (
          ...
          <div className="py-16 text-center">
            <p className="text-gray-400 text-sm">لا يوجد سجلات حضور لهذا اليوم</p>
            <p className="text-gray-300 text-xs mt-1">تأكد من وجود طلاب مضافين</p>
          </div>
        ) : (
